...
GBAN_HANDLER = CommandHandler("giben", gban, run_async=True)
UNGBAN_HANDLER = CommandHandler("ungiban", ungban, run_async=True)
GBAN_LIST = CommandHandler("daftargban", gbanlist, run_async=True)
