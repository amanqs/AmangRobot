...
from AmangRobot import (
    DEV_USERS,
    EVENT_LOGS, 
    BOT_USERNAME,
    ubot2,
)
from AmangRobot import pbot as app 
from AmangRobot import arq
from AmangRobot.services.keyboard import Ikb
from AmangRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from AmangRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from AmangRobot.services.types import InlineQueryResultCachedDocument
from AmangRobot.modules.info import get_chat_info, get_user_info
from AmangRobot.modules.music import download_youtube_audio
from AmangRobot.utils.functions import test_speedtest
from AmangRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    ubot_state = "Alive" if await ubot2.get_me() else "Dead"
    buttons.add(
    ...
    msg = f"""
**[Amang Robot ❤️](https://t.me/amangsupportgrup):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/amwang)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
