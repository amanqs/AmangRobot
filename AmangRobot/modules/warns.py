...
import telegram
from AmangRobot import TIGERS, WOLVES, dispatcher
from AmangRobot.modules.disable import DisableAbleCommandHandler
from AmangRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from AmangRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from AmangRobot.modules.helper_funcs.string_handling import split_quotes
from AmangRobot.modules.log_channel import loggable
from AmangRobot.modules.sql import warns_sql as sql
    ...
    if num_warns >= limit:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "❌ Remove", callback_data=f"rm_warn({user.id})"
                    )
                ]
            ]
        )
