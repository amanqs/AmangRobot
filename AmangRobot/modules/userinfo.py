...
from AmangRobot.__main__ import STATS, TOKEN, USER_INFO
from AmangRobot.modules.sql import SESSION
import AmangRobot.modules.sql.userinfo_sql as sql
from AmangRobot.modules.disable import DisableAbleCommandHandler
from AmangRobot.modules.sql.global_bans_sql import is_user_gbanned
from AmangRobot.modules.sql.afk_sql import is_afk, set_afk
from AmangRobot.modules.sql.users_sql import get_user_num_chats
from AmangRobot.modules.helper_funcs.chat_status import sudo_plus
from AmangRobot.modules.helper_funcs.extraction import extract_user
from AmangRobot import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Amang Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By amangtele 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
